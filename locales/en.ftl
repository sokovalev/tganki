...
admin-payments-title = 💳 Latest payments (date · tg_id · product · amount, charge id below):
admin-payments-empty = No payments yet.
admin-refund-usage = Usage: /admin refund <charge_id>. Find the charge id via /admin payments.
