...
admin-payments-title = 💳 Последние платежи (дата · tg_id · товар · сумма, ниже — id платежа):
admin-payments-empty = Платежей пока нет.
admin-refund-usage = Использование: /admin refund <charge_id>. Id платежа смотри в /admin payments.
